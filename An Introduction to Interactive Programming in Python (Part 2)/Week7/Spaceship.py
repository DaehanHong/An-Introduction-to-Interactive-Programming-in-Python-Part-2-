...
class Ship:
    ...
    def update(self):
        ...
        pressed_key = 0.40 / 60
        released_key = 0.20
        self.vel[0] *= (1 - pressed_key)
        self.vel[1] *= (1 - pressed_key)
        
        if self.thrust:
            forward = angle_to_vector(self.angle)
            self.vel[0] += released_key * forward[0]
            self.vel[1] += released_key * forward[1]
...
def draw(canvas):
    ...
    canvas.draw_text('lives: ' + str(lives), (50, 50), 36, "Skyblue")
    canvas.draw_text('score: ' + str(score), (625, 50), 36, "Skyblue")
