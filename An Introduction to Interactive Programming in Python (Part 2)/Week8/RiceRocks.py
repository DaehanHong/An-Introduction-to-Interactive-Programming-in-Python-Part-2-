...
def draw(canvas):
    ...
    canvas.draw_text("Lives", [50, 50], 22, "Skyblue")
    canvas.draw_text("Score", [680, 50], 22, "Skyblue")
    canvas.draw_text(str(lives), [50, 80], 22, "Skyblue")
    canvas.draw_text(str(score), [680, 80], 22, "Skyblue")
