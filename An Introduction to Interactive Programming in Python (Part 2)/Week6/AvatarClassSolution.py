...
# of gold carried (in bag) and the amount of gold buried (in the ground).
    ...
    def __str__(self):
        return "Here is "+ self.name +" with " + self.hair_color + " hair " + \
                "\n" + self.name + " has " + str(self.gold_in_bag) + " gold in bag..." \
                "\nand " + str(self.buried_gold) + " gold that is buried!\n\n"
